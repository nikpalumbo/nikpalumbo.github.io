...
function calculatePrice() {
  ...
  // CRM integration
  const crmLevelElement = document.querySelector('input[name="crm-level"]:checked');
  if (!crmLevelElement) return;
  const crmLevel = crmLevelElement.value;
  if (crmLevel === 'advanced') basePrice *= 1.25;
